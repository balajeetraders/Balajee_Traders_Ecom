    ...
    <div ref={containerRef} className="bg-stone-950 min-h-screen">
      ...
      <section className="h-[70vh] md:h-screen relative flex items-center justify-center overflow-hidden">
         ...
         <div className="relative z-20 text-center space-y-6 max-w-4xl px-6">
            ...
            <h1 className="text-6xl md:text-[10vw] font-serif text-white leading-[0.85] tracking-tighter">
              Explore <span className="italic font-light opacity-50">Spaces</span>
            </h1>
            <p className="text-stone-400 text-sm md:text-lg italic font-serif max-w-xl mx-auto leading-relaxed">
      ...
      <section className="pb-40">
        {ROOMS.map((room, idx) => (
          <div 
            ...
            className="room-scene relative h-[80vh] md:h-screen w-full cursor-pointer overflow-hidden border-b border-white/5"
          >
             <img 
              src={room.image} 
             ...
             <div className="absolute inset-0 container mx-auto px-6 md:px-12 flex flex-col justify-end py-24 space-y-8">
                <div className="reveal-text space-y-4">
                   ...
                   <h3 className="text-5xl md:text-[8vw] font-serif text-white leading-none tracking-tighter">{room.type}</h3>
                   <p className="text-stone-400 text-sm md:text-xl italic font-serif max-w-md">
                      {room.description}
                   </p>
                   <div className="pt-6">
                      <button className="flex items-center gap-6 text-[10px] font-black uppercase tracking-[0.4em] text-white border-b border-white/20 pb-3 hover:gap-10 hover:border-white transition-all duration-700">
      ...
      {/* Philosophy Anchor */}
      <section className="py-40 bg-white text-stone-900 rounded-t-[3rem] md:rounded-t-[5rem] text-center px-6">
        <div className="container mx-auto space-y-12">
           <blockquote className="text-3xl md:text-6xl font-serif italic max-w-4xl mx-auto leading-tight font-light">
            "Design is a sensory dialogue between the inhabitant and the architecture."
           </blockquote>
           <div className="w-20 h-px bg-stone-100 mx-auto" />
