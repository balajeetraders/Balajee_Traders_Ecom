          ...
          <div className="w-full lg:w-1/2 max-w-md account-reveal">
            <div className="bg-white border border-stone-100 rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 shadow-2xl space-y-10 relative overflow-hidden">
                  ...
                  {mode === 'signup' && (
                    <div className="animate-in fade-in slide-in-from-top-4 duration-500 space-y-6">
                       <div className="grid grid-cols-2 gap-4">
                          <Input label="First Name" placeholder="Julius" value={firstName} onChange={(e: any) => setFirstName(e.target.value)} required />
                          <Input label="Last Name" placeholder="Wright" value={lastName} onChange={(e: any) => setLastName(e.target.value)} required />
                       </div>
                    </div>
                  )}
                  
                  <Input label="Email Address" type="email" placeholder="julius@example.com" icon={<Mail size={16} />} value={email} onChange={(e: any) => setEmail(e.target.value)} required />
               ...
               <div className="relative flex items-center justify-center py-4">
                  ...
                  <span className="relative px-4 bg-white text-[9px] uppercase tracking-widest font-black text-stone-200">Or</span>
               </div>
